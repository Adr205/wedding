  ...
  return (
    <div className="flex flex-col gap-3 sm:flex-row">
      {invitation.rsvp.enabled ? (
        <a
          className={`inline-flex items-center justify-center gap-2 rounded-full px-6 py-3 font-semibold text-sm transition-colors ${ctaClassName}`}
          href={whatsappLink}
          target="_blank"
          rel="noreferrer"
        >
      ...
      <a
        className="inline-flex items-center justify-center gap-2 rounded-full border border-current px-6 py-3 font-semibold text-sm hover:bg-black/5 transition-colors"
        href={calendarLink}
        target="_blank"
        rel="noreferrer"
      >
