...
import { deleteUpload, setUploadApproved } from "@/features/admin/data/community";
...
export async function PATCH(request: Request, context: RouteContext) {
  ...
  const result = await setUploadApproved(uploadId, body.approved, superAdmin);
...
export async function DELETE(_: Request, context: RouteContext) {
  ...
  const result = await deleteUpload(uploadId, superAdmin);
